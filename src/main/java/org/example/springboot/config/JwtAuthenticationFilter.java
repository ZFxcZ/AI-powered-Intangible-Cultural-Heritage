...
//        return null;
        ...
        if (org.springframework.util.StringUtils.hasText(tokenParam)) {
            log.debug("从 URL 参数中提取 token，前 20 字符：{}",
                    tokenParam.length() > 20 ? tokenParam.substring(0, 20) + "..." : tokenParam);
            return tokenParam;
        }
